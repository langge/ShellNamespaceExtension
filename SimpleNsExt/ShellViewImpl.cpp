...
DWORD dwListExtendedStyles = LVS_EX_FULLROWSELECT | LVS_EX_HEADERDRAGDROP;
    ...
    if ( dwListStyles & LVS_REPORT )
        {
        m_wndList.InsertColumn ( 0, "Drive", LVCFMT_LEFT, 0, 0 );
        m_wndList.InsertColumn ( 1, "Volume Name", LVCFMT_LEFT, 0, 1 );
        m_wndList.InsertColumn ( 2, "Free Space", LVCFMT_LEFT, 0, 2 );
        m_wndList.InsertColumn ( 3, "Total Space", LVCFMT_LEFT, 0, 3 );
        }
